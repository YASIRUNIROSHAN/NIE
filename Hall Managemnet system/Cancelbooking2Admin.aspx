<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Cancelbooking2Admin.aspx.vb" Inherits="Hall_Managemnet_system.Cancelbooking2Admin" %>
    ...
    <table border="0"">
        ...
        <tr>
            <td class="auto-style16">
                <br />
                <strong><span class="auto-style17">Bookin ID</span></strong><br />
                <br />
            </td>
        ...
        <tr>
            <td class="auto-style16">
                <br />
                <span class="auto-style17"><strong>Organization ID</strong></span><br />
                <br />
            </td>
        ...
        <tr>
            <td class="auto-style16">
                <br />
                <span class="auto-style17"><strong>Name</strong></span><br />
                <br />
            </td>
        ...
        <tr>
            <td class="auto-style16">
                <br />
                <strong><span class="auto-style17">Phone Number</span></strong><br />
                <br />
            </td>
            <td class="auto-style20"><asp:TextBox ID="TextBox3" runat="server"  Height="32px" Width="284px" /></td>
        </tr>

        <tr>
            <td class="auto-style16"> 
                <br />
                <span class="auto-style17"><strong>Address</strong></span><br />
                <br />
            </td>
           <td class="auto-style20"><asp:TextBox ID="TextBox4" runat="server"  Height="32px" Width="284px" /></td>
        </tr>

         <tr>
            <td class="auto-style16"> 
                <br />
                <strong><span class="auto-style17">Email</span></strong><br />
                <br />
             </td>
           <td class="auto-style20"><asp:TextBox ID="TextBox5" runat="server"  Height="32px" Width="284px" /></td>
        </tr>

         <tr>
            <td class="auto-style16"> 
                <br />
                <strong><span class="auto-style17">Amount</span></strong><br />
                <br />
             </td>
           <td class="auto-style20"><asp:TextBox ID="TextBox6" runat="server"  Height="32px" Width="284px" /></td>
        </tr>

         <tr>
            <td class="auto-style16"> 
                <br />
                <strong><span class="auto-style17">Paid Amount<br />
                </span></strong>
                <br />
             </td>
           <td class="auto-style20"><asp:TextBox ID="TextBox7" runat="server"  Height="32px" Width="284px" /></td>
        </tr>
        ...
        <tr>
            ...
            <td class="auto-style21">
                <asp:Button ID="Button2" runat="server" CssClass="newStyle5" Height="48px" Text="Cancel" Width="158px" />
            </td>
        </tr>
    </table>
  </div>
